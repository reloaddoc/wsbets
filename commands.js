...
sGameName = "WSB/GME Saga - DFV view (Click text)";
...
aCommands = {
	...
	"Do financial research on GameStop": [
		...
		["t", "You're studying GameStop's financial reports and discover that the company is in bad shape. CEOs are coming and going, losses and debt are piling up, digital downloads are the future, foot traffic for GameStop stores is falling."],
	...
	"WSB2":[
		...
		["t", "Then, out of nowhere, an investor named Ryan Cohen invests in GameStop. Wow! He successfully built an online pet-food retailer and many people pin their hopes on him to transform GameStop."],
	...
	"Hold":[
		...
		["t", "It's become a full assault on Wall Street by now. The short sellers are getting nervous. GameStop shares trade at $300 now. Eventually you sell some shares, but hold on to a huge amount."],
		...
		["t", "You've created a whole movement of people investing in GameStop to 'stick it to the man'. Many trade on popular brokers that are basically free to trade on. Many invest for the first time."],
		...
		["b", "It's Wednesday now. You decide to visit your local GameStop, which has closed down. You go to bed.", "Showdown"]
	],
	"Showdown":[
		["i", "images/robin.png"],
		["t", "It's Thursday! One day before the potential showdown. Shares of firms such as Nokia, AMC, GameStop or Naked are rising a lot. Traditional TV channels scramble to understand what is going on. People call you and your WSB crew a cartel and mob."],
		["t", "You slept well though and feel calm. However, many of the brokers that were used to trade GameStop and other shares decided it was all too risky for them and heavily limited trading. People are no longer able to buy GameStop in large amounts. They cry foul."],
		["t", "Given these trading disruptions, GameStop shares fluctuate heavily. They fall, rise, and fall again."],
